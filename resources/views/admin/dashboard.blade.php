...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Admin Dashboard - DEPED Region V Recruitment</title>
    ...
    <body>
        ...
        <main class="main-content">
            ...
            <!-- Stats Row 2: Role Distribution -->
            <div class="stats-grid" style="margin-bottom: 32px;">
                <div class="stat-card" style="border-left: 3px solid #1e40af;">
                    <div class="stat-label">Applicants</div>
                    <div class="stat-value">{{ $applicantCount }}</div>
                    </div>
                <div class="stat-card" style="border-left: 3px solid #166534;">
                    <div class="stat-label">HR Staff</div>
                    <div class="stat-value">{{ $hrCount }}</div>
                </div>
            ...
            <div class="content-grid">
                ...
                <div class="card">
                    <div class="section-header">
                        ...
                        <a href="{{ route('admin.users') }}" class="section-link">Manage Users</a>
                    </div>
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" style="text-align: center; color: var(--color-muted);">No users yet</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="card">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" style="text-align: center; color: var(--color-muted);">No job postings</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
